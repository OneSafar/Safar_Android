...
object HabitModule {
    ...
    @Provides
    @Singleton
    fun provideFeatureAccessManager(defaultManager: com.safarparmar.app.feature.habits.premium.DefaultFeatureAccessManager): com.safarparmar.app.feature.habits.premium.FeatureAccessManager = defaultManager
}
