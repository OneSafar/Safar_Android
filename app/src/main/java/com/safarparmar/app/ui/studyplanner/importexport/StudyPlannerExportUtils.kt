package com.safarparmar.app.ui.studyplanner.importexport
...
object StudyPlannerExportUtils {
    ...
    private class PdfWriter(private val document: PdfDocument) {
        ...
        private fun drawFooter(canvas: Canvas) {
            ...
            canvas.drawText("Generated by Safar Exam Planner • $timestamp • Page $pageNumber", PAGE_WIDTH / 2f, PAGE_HEIGHT - MARGIN + 15f, footerPaint)
        }
    }
