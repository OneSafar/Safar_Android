...
fun PlannerExamDateField(
    ...
    Row(
        ...
        OutlinedButton(
            ...
            border = if (isError) androidx.compose.foundation.BorderStroke(1.dp, MaterialTheme.colorScheme.error) else androidx.compose.material3.ButtonDefaults.outlinedButtonBorder(enabled = true),
