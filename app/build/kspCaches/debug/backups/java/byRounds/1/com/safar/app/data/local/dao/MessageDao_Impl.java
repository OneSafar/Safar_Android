...
import com.safar.app.data.local.entity.MessageEntity;
...
public final class MessageDao_Impl implements MessageDao {
  ...
  public MessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMessageEntity = new EntityInsertionAdapter<MessageEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `messages` (`id`,`conversationId`,`senderId`,`content`,`isRead`,`timestamp`) VALUES (?,?,?,?,?,?)";
      }
  ...
  @Override
  public Object markConversationAsRead(final String conversationId,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      ...
      public List<MessageEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new MessageEntity(_tmpId,_tmpConversationId,_tmpSenderId,_tmpContent,_tmpIsRead,_tmpTimestamp);
            _result.add(_item);
          }
          return _result;
        } finally {
